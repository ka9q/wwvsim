...
wwvsim - program to do something

# SYNOPSIS

**wwvsim** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**wwvsim** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **wwvsim** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**wwvsim** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    wwvsim. See **foo.conf**(5) for further details.
...
**wwvsim** provides some return codes, that can be used in scripts:
